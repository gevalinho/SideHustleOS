      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-6 pb-16 lg:px-8 lg:pb-20">
          <header className="flex items-center justify-between gap-6">
            ...
            <Link href="/" className="rounded-md bg-olive-950 px-4 py-2 text-sm font-medium text-white dark:bg-white dark:text-olive-950">
              Open dashboard
            </Link>
          </header>
          ...
          <div className="mt-16 grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link href="/" className="inline-flex h-11 items-center justify-center gap-2 rounded-md bg-olive-950 px-5 text-sm font-semibold text-white hover:bg-olive-800">
                  View product dashboard <ArrowNarrowRightIcon className="size-3" />
                </Link>
      ...
      <section id="hackathon-pitch" className="px-6 pb-16 lg:px-8">
        <div className="mx-auto max-w-7xl rounded-xl bg-olive-950 px-6 py-10 text-white dark:bg-white dark:text-olive-950 lg:px-10">
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            ...
            <Link href="/" className="inline-flex h-11 items-center justify-center gap-2 rounded-md bg-white/10 px-5 text-sm font-semibold text-white hover:bg-white/20 dark:bg-olive-950 dark:text-white dark:hover:bg-olive-800">
              Open the dashboard <ArrowNarrowRightIcon className="size-3" />
            </Link>
          </div>
        </div>
      </section>
